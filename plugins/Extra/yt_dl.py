...
async def song(client, message):
    ...
    try:
        ...
        print(str(e))
        return await m.edit("Example: /song Jigelu Rani Telugu song")
    ...
    try:
        ...
        cap = "**BY›› [Priya NETWORKS™](https://t.me/Sai_File_Store_CC)**"
...
async def vsong(client, message: Message):
    ...
    if not urlissed:
        return await pablo.edit("Example: /video Your UTUBE video link")     
